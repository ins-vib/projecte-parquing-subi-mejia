        ...
        <tbody >
            @foreach($cotxes as $cotxe)
                <tr>
                    ...
                    <td class="px-6 py-4 font-medium text-red-600 dark:text-red-500 hover:underline ms-3"><a href="/aparcar/operador/cotxes/{{$parking->id}}/plantes/{{$cotxe->id}}">Aparcar</a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
