        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-black">
            ...
            <tbody >
                ...
                <tr >
                    ...
                    <td class="px-6 py-4 font-medium text-blue-600 dark:text-blue-500 hover:underline"><a href="/aparcar/operador/cotxes/{{$parking->id}}/plantes/{{$cotxe->id}}/{{$planta->id}}">Plaçes</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
