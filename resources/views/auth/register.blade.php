...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen gap-6">
    ...
    <div class="w-full max-w-md bg-white shadow-md rounded-xl p-8">
        ...
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Registra't</h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">Confirma la contrasenya</label>
